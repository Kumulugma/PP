...
echo apply_filters(
    ...
    sprintf(
        '<a href="%s" data-quantity="%s" class="btn btn-secondary btn-addtocart %s" %s><span><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
