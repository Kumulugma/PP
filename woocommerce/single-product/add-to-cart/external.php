...
<form class="cart" action="<?php echo esc_url( $product_url ); ?>" method="get">
	...
	<button type="submit" class="btn btn-secondary btn-addtocart single_add_to_cart_button button alt<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"><span><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg></span><?php echo esc_html( $button_text ); ?></button>
