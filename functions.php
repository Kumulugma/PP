...
require_once 'includes/admin/polski-podarek-admin-loader.php';
...
require_once 'includes/seo/document-title.php';
require_once 'includes/seo/schema-markup.php';
...
require_once 'includes/theme/footer-scripts.php';
